...
<header class="grid grid-cols-9 max-w-screen-lg mx-auto min-h-[430px]">
    <section class="col-span-4 relative">
      ...
      text-white text-center text-5xl font-semibold shadow-xl">foodbar
        ...
        <transition name="heroImage" @after-leave="onAfterLeave" class="absolute top-[70px] origin-center translate-x-1/2 right-1/2 w-[370px] h-[370px]">
...
<Carousel @showSelectedDish="handleSelectedDish" :carouselItems="carouselItems" class="max-w-[920px] mx-auto mt-6" />
</template>
...
.heroDesc-leave-active .heroDescTitle-leave-active .heroDesc-leave-active {
